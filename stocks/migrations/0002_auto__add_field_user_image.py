...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stocks_user', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='http://www.mygolfkaki.com/DesktopModules/Custom%20Module/Member%20Management/Image/default.gif', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.image'
        db.delete_column(u'stocks_user', 'image')
