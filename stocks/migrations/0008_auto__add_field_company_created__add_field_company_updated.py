...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stocks_company', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Company.updated'
        db.add_column(u'stocks_company', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 7, 24, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'stocks.company': {
            ...
            'address1': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
            ...
            'imageurl': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
