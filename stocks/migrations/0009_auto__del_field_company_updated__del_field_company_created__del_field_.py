...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'stocks_company', 'updated')

        # Deleting field 'Company.created'
        db.delete_column(u'stocks_company', 'created')

        # Deleting field 'Company.imageurl'
        db.delete_column(u'stocks_company', 'imageurl')
        ...
        db.delete_column(u'stocks_user', 'balance')


    def backwards(self, orm):
        # Adding field 'Company.updated'
        db.add_column(u'stocks_company', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Company.created'
        db.add_column(u'stocks_company', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Company.imageurl'
        db.add_column(u'stocks_company', 'imageurl',
        ...
        db.add_column(u'stocks_user', 'balance',
                      self.gf('django.db.models.fields.IntegerField')(default=100, max_length=10),
                      keep_default=False)
